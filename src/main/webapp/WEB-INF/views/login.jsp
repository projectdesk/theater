...
<div class="idcheck">
  <form method="post" action="login.do">
        <table>
          ...
          <tr>
            <td class="log_form"><input type="password"
              name="password"></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><span class="button_left"><input
                type="button" value="회원가입" onclick="location.href='register.do'"></span> <span
              class="button_right"><input type="button"
                value="ID/PW찾기" onclick="location.href='findidpw.do'"></span></td>
          </tr>
        </table>
         </form>
</div>
