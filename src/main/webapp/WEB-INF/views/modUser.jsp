              ...
              <form method="post" action="update_user.do">
                ...
                <table>
                  <tr>
                    ...
                    <td class="b_body_in"><input type="text"
                      name="id" readonly="readonly" value="${user.id}"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="b_body_in"><input type="text"
                      name="birthday" id="datepicker"
                      value="${user.birthday}"></td>
                  </tr>
                  <tr>
                    <td class="b_body_title">E-Mail</td>
                    <td class="b_body_in"><input type="email"
                      name="email" value="${user.email}"></td>
                  </tr>
                  <tr>
                    <td class="b_body_title">우편번호</td>
                    <td class="b_body_in"><input type="text"
                      name="zipcode" id="zipcode" placeholder=" 우편번호 검색"
                      readonly="readonly" value="${user.zipcode}">
                      <br> <input type="button" value=" 우편번호찾기"
                      onClick="addressSearch()"></td>
                  </tr>
                  <tr>
                    <td class="b_body_title">주소</td>
                    <td class="b_body_in"><input type="text"
                      name="address1" id="address1"
                      placeholder=" 주소를 검색해주세요." readonly="readonly"
                  ...
                  <tr>
                    ...
                    <td class="b_body_in"><input type="text"
                      ...
                      placeholder=" 상세주소를 적어 주세요."
                      value="${user.address2}"></td>
                  </tr>
                  <tr>
                    <td class="b_body_title">핸드폰 번호</td>
                    <td class="b_body_in"><input type="text"
                      name="phone" placeholder=" 핸드폰번호를 적어 주세요."
                      value="${user.phone}"></td>
                  </tr>
                </table>
                <p class="line"></p>
                ...
                <a href="ListBest.do">
                  <div class="notice">
                    <ul>
                      ...
                      <li class="li_body"><strong>MOVIE
                          CINEMA</strong>에 궁금한 사항을 물어보세요 <br> 언제나 친절하게 답해주는<strong>
                          MOVIE CINEMA</strong>가 되겠습니다.</li>
                    </ul>
                  </div>
                </a> 
                  <div class="notice_2">
